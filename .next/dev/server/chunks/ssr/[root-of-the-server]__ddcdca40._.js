...
"[project]/app/firestore.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$firestore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/firestore.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (user) {
            const fetchTasks = async ()=>{
                const userTasks = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$firestore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTasks"])(user.uid);
                setTasks(userTasks);
            };
            fetchTasks();
        }
    ...
    const handleAddTask = async (e)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$firestore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addTask"])(user.uid, newTaskText);
        setNewTaskText("");
        const userTasks = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$firestore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTasks"])(user.uid);
        setTasks(userTasks);
    };
    const handleToggleTask = async (task)=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$firestore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateTask"])(task.id, {
    ...
    const handleDeleteTask = async (taskId)=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$firestore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteTask"])(taskId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ddcdca40._.js.map